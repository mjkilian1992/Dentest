angular.module('questions').controller('QuestionSearchCtrl', ['QuestionService', '$routeParams',
    function (QuestionService, $routeParams) {
        ...
        self.questions = [];
        self.error = false;
        self.search_string = $routeParams.search_string || ' ';
        ...
        var retrieve_questions = function (page_number) {
            QuestionService.getQuestionsSearch(page_number,self.search_string).then(success, error);
        };
